...
namespace YuYan.Interface.Repository
{
    public interface IYuYanDBRepository : IDisposable
    {
        ...
        #region result
        Task<IList<tbSurveyResult>> GetSurveyResultsBySurveyId(int surveyId, int? score = null);
        ...
        Task<tbImage> UpdateImage(dtoImage image);
        Task<tbImage> UpdateImageWithRefId(Guid imgId, int refId);
        #endregion
